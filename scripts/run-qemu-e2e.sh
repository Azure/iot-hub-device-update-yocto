...
UBOOT="$(ls "$DEPLOY"/u-boot-qemuarm64-*.bin 2>/dev/null | head -1 || true)"
WIC_ORIG="$(ls "$DEPLOY"/adu-base-image-qemuarm64.rootfs-*.wic 2>/dev/null | head -1 || true)"
SWU_V1="$(ls "$DEPLOY"/adu-update-image-v1-[0-9]*.swu 2>/dev/null | head -1 || true)"
SWU_V1_RECOMP="$(ls "$DEPLOY"/adu-update-image-v1*-recompressed.swu 2>/dev/null | head -1 || true)"
DELTA_V1_V2="$(ls "$DEPLOY"/adu-delta-v1-to-v2*.diff 2>/dev/null | head -1 || true)"
SWU_V2="$(ls "$DEPLOY"/adu-update-image-v2-[0-9]*.swu 2>/dev/null | head -1 || true)"
SWU_V2_RECOMP="$(ls "$DEPLOY"/adu-update-image-v2*-recompressed.swu 2>/dev/null | head -1 || true)"
SWU_V3="$(ls "$DEPLOY"/adu-update-image-v3-[0-9]*.swu 2>/dev/null | head -1 || true)"
DELTA_V2_V3="$(ls "$DEPLOY"/adu-delta-v2-to-v3*.diff 2>/dev/null | head -1 || true)"
SWU_V2_RECOMP_SHA="$(ls "$DEPLOY"/adu-update-image-v2*-recompressed.swu.sha256 2>/dev/null | head -1 || true)"
SWU_V3_RECOMP="$(ls "$DEPLOY"/adu-update-image-v3*-recompressed.swu 2>/dev/null | head -1 || true)"
SWU_V3_RECOMP_SHA="$(ls "$DEPLOY"/adu-update-image-v3*-recompressed.swu.sha256 2>/dev/null | head -1 || true)"
