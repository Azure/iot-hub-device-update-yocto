...
from azure.iot.deviceupdate import ImportUpdateInput, ImportManfiestMetadata, FileImportMetadata
...
class DeviceUpdateTestHelper:
    ...
    def StartDeploymentForGroup(self, deploymentId, groupName, updateId):
        ...
        jsonBodyString = '{"deploymentId": "' + deploymentId + '","groupId": "' + groupName + '","startDateTime": "' + str(datetime.now()) + '","update":{ "updateId": ' + str(updateId) + ' } }'
